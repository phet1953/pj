...
function select_unitdrug(){
    ...
    if(mysqli_num_rows($query) > 0){
        ...
        <thead>
         <tr>
          <th bgcolor='#ffe6ee' class='col-md-1 col-xs-1'><center>หน่วยนับ[ขนาดยา]</center></th>
        ...
        while($re = mysqli_fetch_assoc($query)) {
            ...
            echo "<td>
            <input type='image' id='edit".$re['ID_unitdrug']."' onclick=unitdrug_edit('".$re['ID_unitdrug']."') src='https://img.icons8.com/dusk/24/000000/edit-property.png'>
            <input type='image' id='delete' onclick=unitdrug_delete('".$re['ID_unitdrug']."') src='https://img.icons8.com/plasticine/24/000000/filled-trash.png'>
            </td>";
            echo "<tr>";
        }
        echo "</tbody>
