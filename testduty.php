       ...
       <div class="panel-body" style="border-radius: 20px">
        <div class="row">
         <div class="col-md-12">                 
             ...
             <form name="frm" method="post" action="Insert/Insertduty.php">
           <div class="panel-body" style="border-radius: 20px">                           
            <div class="col-md-12">
             <div class="col-md-12 form-group" align="center">
                   <label>ตำแหน่งหน้าที่ในฟาร์ม</label>
                   <input type="text" class="form-control" style="width: 50%" placeholder="ชื่อกิจกรรม"  name="duty">
              <br>
              <center>
...
<?php
           ...
           $sql = "select * from duty limit {$start} , {$perpage} ";
         ...
         <?php
              ...
              while ($re = mysqli_fetch_array($q)) {
               ...
               ?>
                ...
                <td><div style="size: 20px"><?php echo $re['duty_d']; ?></div></td>
                <td>
                 <a href ='duty2.php?CusID=<?=$re["ID_duty"];?>'><img src="https://img.icons8.com/dusk/24/000000/edit-property.png"></a>
                 <a href="JavaScript:if(confirm('Confirm Delete?') == true){window.location='Delect/Delectduty.php?CusID=<?php echo $re["ID_duty"];?>';}"><img src="https://img.icons8.com/plasticine/24/000000/filled-trash.png"></a>
                </td>
...
<div>
            ...
            <nav aria-label="Page navigation example">
             <ul class="pagination">
              <li class="page-item">
                  <a class="page-link" href="duty.php?page=1" aria-label="Previous">
                <span aria-hidden="true">&laquo;</span>
               </a>
              </li>
              <?php for ($re = 1; $re <= $total_page; $re++) { ?>
              <li class="page-item">
                  <a class="page-link" href="duty.php?page=<?php echo $re; ?>"><?php echo $re; ?></a></li>
               <?php } ?>
               <li class="page-item">
                   <a class="page-link" href="duty.php?page=<?php echo $total_page; ?>" aria-label="Next">
